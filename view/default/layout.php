...
';
	...
	<link
		href="<?php echo $Config['WebsitePath']; ?>/static/css/default/style.css?version=<?php echo STACK_BRAIN_VERSION; ?>"
	...
	<script type="text/javascript" charset="utf-8"
			src="<?php echo $Config['WebsitePath']; ?>/static/js/default/global.js?version=<?php echo STACK_BRAIN_VERSION; ?>"></script>
	<script type="text/javascript">
		<?php if ($CurUserID) {
			...
			<div class="inner-nav-panel">
				<div class="logo">
					<a href="<?php echo $Config['WebsitePath']; ?>/">
						<img src="<?php echo $Config['WebsitePath']; ?>/static/img/icon.png"
