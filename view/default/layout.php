...
';
	...
	<link rel="prefetch" href="//<?php echo $Config['MainDomainName']; ?>" /-->
		...
		<link rel="shortcut icon" type="image/ico" href="<?php echo $Config['WebsitePath']; ?>/static/img/icon.png" />
		<link href="<?php echo $Config['WebsitePath']; ?>/static/css/default/style.css?version=<?php echo STACK_BRAIN_VERSION; ?>" rel="stylesheet" type="text/css" />
		...
		<script type="text/javascript" charset="utf-8" src="<?php echo $Config['WebsitePath']; ?>/static/js/default/global.js?version=<?php echo STACK_BRAIN_VERSION; ?>"></script>
		<script type="text/javascript">
			<?php if ($CurUserID) {
				echo 'setTimeout(function() {GetNotification();}, 1);';
			}
			?>
			loadScript(WebsitePath + "/language/<?php echo ForumLanguage; ?>/global.js?version=<?php echo STACK_BRAIN_VERSION; ?>", function() {});
		</script>
	...
	<body>
					...
					<div class="inner-nav-panel">
						<div class="logo">
							<a href="<?php echo $Config['WebsitePath']; ?>/">
								<img src="<?php echo $Config['WebsitePath']; ?>/static/img/icon.png" alt="<?php echo $Lang['Home']; ?>" />
							</a>
						</div>
						<div class="buttons">
							<div class="searchbox">
		...
		?>
			...
			<div class="copyright">
				<p>
					<?php echo $Config['SiteName']; ?> Powered By © 2022 V<?php echo STACK_BRAIN_VERSION; ?>
					<br />
					<?php
