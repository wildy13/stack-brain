...
<div class="main-content">
	...
	<div class="main-box">
		...
		<div class="member-detail">
			<p>
				<?php echo $Lang['UserName']; ?>&nbsp;&nbsp;：<strong style="margin-right:10px ;"><?php echo $UserInfo['UserName']; ?></strong>
				<?php echo $Lang['Age']; ?>:
				<?php
			...
			<p><?php echo $Lang['Website']; ?>： <a href="<?php echo $UserInfo['UserHomepage']; ?>" target="_blank" rel="nofollow"><?php echo $UserInfo['UserHomepage']; ?></a></p>
			<p><?php echo $Lang['Address']; ?>: <?php echo $UserInfo['Address'] ?></p>
			<p><?php echo $Lang['Introduction']; ?>： <?php echo str_replace("\n", "<br \>", $UserInfo['UserIntro']); ?></p>
		</div>
