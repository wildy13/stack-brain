...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $Config['WebsitePath']; ?>/static/css/mobile/appframework.css?version=<?php echo STACK_BRAIN_VERSION; ?>" />
	<link rel="stylesheet" type="text/css" href="<?php echo $Config['WebsitePath']; ?>/static/css/mobile/style.css?version=<?php echo STACK_BRAIN_VERSION; ?>" />
	...
	<script type="text/javascript" charset="utf-8" src="<?php echo $Config['WebsitePath']; ?>/static/js/mobile/appframework.ui.min.js?version=<?php echo STACK_BRAIN_VERSION; ?>"></script>
	<script type="text/javascript" charset="utf-8" src="<?php echo $Config['WebsitePath']; ?>/static/js/mobile/global.js?version=<?php echo STACK_BRAIN_VERSION; ?>"></script>
	<script type="text/javascript" charset="utf-8" src="<?php echo $Config['WebsitePath']; ?>/language/<?php echo ForumLanguage; ?>/global.js?version=<?php echo STACK_BRAIN_VERSION; ?>"></script>
<?php
